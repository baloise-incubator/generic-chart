...
{{/*
Create default route host depending on `generic-chart.fullname` and `.Values.route.zone` ("ch" or "shared")
*/}}
...
{{- printf "%s.%sapp%s.os1.balgroupit.com" (include "generic-chart.fullname" . ) (required "A valid .Values.route.zone is required when using default host!" $prefix) $suffix -}}
{{- end -}}